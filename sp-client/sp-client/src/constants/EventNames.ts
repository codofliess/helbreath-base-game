...
/** Emitted when player talks to Magic Shop NPC (Gandalf) */
export const OUT_UI_OPEN_MAGIC_SHOP = 'ui-open-magic-shop';
/** Emitted when player talks to a quest-giver NPC. Payload: { personId: number } */
export const OUT_UI_OPEN_QUEST_DIALOG = 'ui-open-quest-dialog';
