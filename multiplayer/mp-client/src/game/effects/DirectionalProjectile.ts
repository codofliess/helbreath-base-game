...
export abstract class DirectionalProjectile {
    ...
    private update(delta: number): void {
        ...
        this.updateDepth(currentY);
    }

    private updateDepth(pixelY: number): void {
        this.asset.setDepth(convertPixelPosToWorldPos(pixelY) * DEPTH_MULTIPLIER + PROJECTILE_DEPTH_OFFSET);
    }
