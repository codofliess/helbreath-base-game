...
/// committed <c>PlaytestKits/</c> template) wins; Postgres is not opened. Never writes live
/// <c>Chars/</c>. Live traveler <c>Elon</c> uses the allowlisted ops overlay, not this seeder.
/// </summary>
