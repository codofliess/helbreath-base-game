...
import {
    controlsDialogStore,
    toggleControlsDialogCollapsed,
} from '../store/ControlsDialog.store';
...
export function ControlsDialog({
    ...
    const isCollapsed = useStore(controlsDialogStore, (state) => state.isCollapsed);
    ...
    if (isCollapsed) {
        return (
            ...
            >
                <div className="controls-dialog-collapsed">
                    <RpgButton onClick={() => toggleControlsDialogCollapsed()}>Expand menu</RpgButton>
                </div>
            </DraggableDialog>
        );
    }
    ...
    return (
        <DraggableDialog title="Controls" position={position} id="main-dialog" zIndex={zIndex} onBringToFront={onBringToFront}>
            <div className="controls-dialog-toolbar">
                <RpgButton onClick={() => toggleControlsDialogCollapsed()}>Minimize</RpgButton>
            </div>
            <div>
