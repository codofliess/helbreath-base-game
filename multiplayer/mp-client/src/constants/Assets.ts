...
export const ASSETS: AssetData[] = [
    ...
    { key: 'map-elvbrk11', fileName: 'elvbrk11.amd', assetType: AssetType.MAP, mapName: 'Elvine Barracks 1-1', minimap: Minimap.NONE },
    { key: 'map-elvbrk12', fileName: 'elvbrk12.amd', assetType: AssetType.MAP, mapName: 'Elvine Barracks 1-2', minimap: Minimap.NONE },
    { key: 'map-elvbrk21', fileName: 'elvbrk21.amd', assetType: AssetType.MAP, mapName: 'Elvine Barracks 2-1', minimap: Minimap.NONE },
    { key: 'map-elvbrk22', fileName: 'elvbrk22.amd', assetType: AssetType.MAP, mapName: 'Elvine Barracks 2-2', minimap: Minimap.NONE },
    { key: 'map-elvjail', fileName: 'elvjail.amd', assetType: AssetType.MAP, mapName: 'Elvine Jail', minimap: Minimap.NONE },
    ...
    { key: 'map-bsmith_1f', fileName: 'bsmith_1f.amd', assetType: AssetType.MAP, mapName: 'Farm Blacksmith (Ares)', minimap: Minimap.NONE },
    { key: 'map-bsmith_2f', fileName: 'bsmith_2f.amd', assetType: AssetType.MAP, mapName: 'Farm Blacksmith (Elv)', minimap: Minimap.NONE },
    { key: 'map-gshop_1', fileName: 'gshop_1.amd', assetType: AssetType.MAP, mapName: 'Shop', minimap: Minimap.NONE },
    { key: 'map-gshop_1f', fileName: 'gshop_1f.amd', assetType: AssetType.MAP, mapName: 'Farm Shop (Ares)', minimap: Minimap.NONE },
    { key: 'map-gshop_2f', fileName: 'gshop_2f.amd', assetType: AssetType.MAP, mapName: 'Farm Shop (Elv)', minimap: Minimap.NONE },
    { key: 'map-wrhus_1', fileName: 'wrhus_1.amd', assetType: AssetType.MAP, mapName: 'Warehouse', minimap: Minimap.NONE },
    { key: 'map-wrhus_1f', fileName: 'wrhus_1f.amd', assetType: AssetType.MAP, mapName: 'Farm Warehouse (Ares)', minimap: Minimap.NONE },
    { key: 'map-wrhus_2f', fileName: 'wrhus_2f.amd', assetType: AssetType.MAP, mapName: 'Farm Warehouse (Elv)', minimap: Minimap.NONE },
    ...
    { key: 'map-bisle', fileName: 'bisle.amd', assetType: AssetType.MAP, mapName: 'Bleeding Island', minimap: Minimap.PRE_GENERATED },
