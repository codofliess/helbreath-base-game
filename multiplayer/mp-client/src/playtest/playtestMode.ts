...
/** Must match server PlaytestMode.Seats. */
export const PLAYTEST_SEATS: PlaytestSeat[] = [
    { seatKey: 'elon', accountId: 'playtest-elonqa', characterName: 'ElonQa', agentLabel: 'Elon' },
    { seatKey: 'maggy', accountId: 'playtest-maggy', characterName: 'MaggyQa', agentLabel: 'Maggy' },
    { seatKey: 'pist', accountId: 'playtest-pist', characterName: 'PistQa', agentLabel: 'PIST' },
    { seatKey: 'stalk', accountId: 'playtest-stalk', characterName: 'StalkQa', agentLabel: 'Stalk Bot' },
    { seatKey: 'pulpo', accountId: 'playtest-pulpo', characterName: 'PulpoQa', agentLabel: 'Pulpo' },
    { seatKey: 'proj', accountId: 'playtest-proj', characterName: 'ProjQa', agentLabel: 'Projects Manager' },
    { seatKey: 'paio', accountId: 'playtest-paio', characterName: 'PaioQa', agentLabel: 'PaioPez' },
];
...
/** Resolve seat from ?seat= / localStorage / default elon. */
export function resolvePlaytestSeat(): PlaytestSeat {
    ...
    const found = PLAYTEST_SEATS.find((seat) => seat.seatKey === key);
    const seat = found ?? PLAYTEST_SEATS[0];
    try {
