...
import { BAG_DIALOG_BG, BAG_TAB_LEFT, BAG_TAB_RIGHT } from '../../constants/SpriteKeys';
import { mapDialogStore } from '../store/MapDialog.store';
import { ITEMS, ItemTypes, getItemInventorySpriteKeyWithOverrides, getGlowEffectColor, getGlareEffectColor, getTintAppearanceEffectColor, getTintInventoryEffectColorWithOverrides, RING_SLOT_LEFT, type Effect, type EquipmentSlot } from '../../constants/Items';
...
export function InventoryDialog({
    ...
    return (
        ...
        >
            <div
                className="olympia-dialog-root bag-dialog-root"
                style={bagBg ? {
