    ...
    useEffect(() => {
        ...
        const handleWindowFocus = () => {
            ...
            fadeTimeout = window.setTimeout(() => {
                ...
                const audioContext = (game.current.sound as Phaser.Sound.WebAudioSoundManager).context as AudioContext | undefined;
                if (audioContext?.state === 'suspended') {
                    console.log('[PhaserGame] AudioContext suspended — skipping fade-in until next user gesture');
                    return;
                }
        ...
        return () => {
            ...
            document.removeEventListener('pointerdown', unlockAudioOnGesture, { capture: true });
            if (fadeInterval !== undefined) {
                clearInterval(fadeInterval);
            }
            if (fadeTimeout !== undefined) {
