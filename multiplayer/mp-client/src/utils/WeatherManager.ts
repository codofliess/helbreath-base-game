...
import { SOUND_PLAY_SKIPPED_ID, type SoundManager } from './SoundManager';
...
export class WeatherManager {
    ...
    private startRainSound(): void {
        ...
        try {
            const rainId = this.soundManager.playInLoop(RAIN_SOUND);
            if (rainId !== SOUND_PLAY_SKIPPED_ID) {
                this.rainSoundId = rainId;
            }
        } catch (e) {
