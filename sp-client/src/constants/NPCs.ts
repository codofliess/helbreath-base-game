...
export const NPCS: NPCData[] = [
    ...
    { name: 'Guard', sprite: 'guard' },
    { name: 'Giant Lizard', sprite: 'giantlizard' },
    { name: 'Wyvern', sprite: 'wyvern' },
    { name: 'Fire Wyvern', sprite: 'firewyvern' },
];
...
export function getNPCData(sprite: string): NPCData | undefined {
    const normalized = sprite.toLowerCase();
    return NPCS.find((npc) => npc.sprite.toLowerCase() === normalized);
}
