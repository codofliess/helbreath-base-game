...
export function MapDialog({
    ...
    const gameWorlds = useStore(controlsDialogStore, (state) => state.gameWorlds);
    ...
    const showServerTeleportCells = useStore(mapDialogStore, (state) => state.showServerTeleportCells);
    ...
    return (
        ...
        >
            ...
            <RpgCheckbox
                id="teleport-cells"
                label="Display map teleport cells"
                checked={showTeleportCells}
                onCheckedChange={setShowTeleportCells}
            />

            <RpgCheckbox
                id="server-teleport-cells"
                label="Display server teleport cells"
                checked={showServerTeleportCells}
                onCheckedChange={setShowServerTeleportCells}
            />
