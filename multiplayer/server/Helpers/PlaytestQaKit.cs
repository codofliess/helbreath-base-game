...
/// <summary>
/// PLAYTEST=1 only. Fresh seat characters get a combat-ready kit from the item catalog.
/// Applied only when bag and paperdoll are both empty after the starter seed, so later GM edits persist.
/// </summary>
