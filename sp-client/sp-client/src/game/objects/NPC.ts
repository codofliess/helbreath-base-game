...
import type { NpcRole } from '../../constants/MapNpcPlacements';
...
type NPCConfig = {
    ...
    /** Optional line shown when the player talks to this NPC */
    greeting?: string;

    /** Special interaction role (magic shop, etc.) */
    role?: NpcRole;

    /** Olympia person id for quest givers */
    personId?: number;
};
...
export class NPC extends GameObject {
    ...
    /** Olympia person id (quest givers) */
    ...
    constructor(scene: Scene, config: NPCConfig) {
        ...
        this.greeting = config.greeting ?? `Greetings, traveler. I am ${config.displayName}.`;
    ...
    /** Returns the greeting shown when the player talks to this NPC. */
    public getGreeting(): string {
        return this.greeting;
    }

    public getRole(): NpcRole {
        return this.role;
    }
