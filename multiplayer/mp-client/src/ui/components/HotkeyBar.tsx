...
import { openCastDialogOnCircle } from '../store/CastDialog.store';
...
const HUD_ICONS: HudIcon[] = [
    { key: HUD_ICON_CHARACTER, label: 'Char', title: 'Character (F5)', fKey: 'F5', onClick: toggleCharacterDialog },
    { key: HUD_ICON_INVENTORY, label: 'Bag', title: 'Bag / Item Drops (F6)', fKey: 'F6', onClick: toggleInventoryDialog },
    { key: HUD_ICON_MAGIC, label: 'Magic', title: 'Magic Book (F7)', fKey: 'F7', onClick: () => openCastDialogOnCircle(1) },
    { key: HUD_ICON_SKILLS, label: 'Skill', title: 'Skills (F8)', fKey: 'F8', onClick: toggleControlsDialog },
    { key: HUD_ICON_CHAT, label: 'Chat', title: 'Chat (F9)', fKey: 'F9', onClick: toggleChatDialog },
